...
impl<'a> _TXTSW<'a> {
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        self.w.bits &= !(0xFF_FF << 0);
        self.w.bits |= ((value as u32) & 0xFF_FF) << 0;
        self.w
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn et(&self) -> ETR {
        let bits = ((self.bits >> 22) & 0x01) as u8;
        ETR { bits }
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn txts(&self) -> TXTSR {
        let bits = ((self.bits >> 0) & 0xFF_FF) as u16;
        TXTSR { bits }
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn et(&mut self) -> _ETW {
        _ETW { w: self }
    }
    #[inline(always)]
    pub fn edl(&mut self) -> _EDLW {
        _EDLW { w: self }
    }
    #[inline(always)]
