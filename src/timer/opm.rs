...
opm_hal! {
    ...
    TIM3: (Channel1, cc1e, ccmr1_output, oc1m, oc1fe, ccr1, arr),
    TIM3: (Channel2, cc2e, ccmr1_output, oc2m, oc2fe, ccr2, arr),
    TIM3: (Channel3, cc3e, ccmr2_output, oc3m, oc3fe, ccr3, arr),
    TIM3: (Channel4, cc4e, ccmr2_output, oc4m, oc4fe, ccr4, arr),
...
opm! {
    TIM1: (apb2enr, apb2rstr, tim1, tim1en, tim1rst),
    TIM3: (apb1enr1, apb1rstr1, tim3, tim3en, tim3rst),
    // TIM14: (apbenr2, apbrstr2, tim14, tim14en, tim14rst),
    TIM16: (apb2enr, apb2rstr, tim16, tim16en, tim16rst),
    TIM17: (apb2enr, apb2rstr, tim17, tim17en, tim17rst),
}

#[cfg(feature = "stm32g0x1")]
opm! {
    TIM2: (apb1enr1, apb1rstr1, tim2, tim2en, tim2rst),
}

#[cfg(any(feature = "stm32g070", feature = "stm32g071", feature = "stm32g081"))]
opm! {
    TIM15: (apb2enr, apb2rstr, tim15, tim15en, tim15rst),
}
