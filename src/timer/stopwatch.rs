...
stopwatches! {
    ...
    // TIM14: (tim14, tim14en, tim14rst, apb2enr, apb2rstr, cnt),
...
stopwatches! {
    TIM2: (tim2, tim2en, tim2rst, apb1enr1, apb1rstr1, cnt_l, cnt_h),
}

#[cfg(any(feature = "stm32g070", feature = "stm32g071", feature = "stm32g081"))]
stopwatches! {
    TIM6: (tim6, tim6en, tim6rst, apb1enr1, apb1rstr1, cnt),
    TIM7: (tim7, tim7en, tim7rst, apb1enr1, apb1rstr1, cnt),
    TIM15: (tim15, tim15en, tim15rst, apb2enr, apb2rstr, cnt),
}
